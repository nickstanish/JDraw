...
public class DrawToolbar extends JToolBar {
  ...
  JToggleButton pencilButton, eraserButton, colorDropperButton;
  ...
  private void initialize() {
    ...
    colorDropperButton = new DrawToggleButton("Dropper", colorDropperListener, toolsGroup);
    this.add(pencilButton, eraserButton, colorDropperButton);
  }
  ...
  private ActionListener colorDropperListener = new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      toolManager.selectTool(ToolName.COLOR_DROPPER);
    }
  };
}

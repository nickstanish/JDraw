...
public class DrawWindow extends JFrame {
  ...
  private void initialize() {
    ...
    canvas = new Canvas();
    this.scrollCanvas =
        new JScrollPane(canvas, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
    ...
    setShortcuts(menuBar.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW), menuBar.getActionMap());
  }
  ...
  private void setShortcuts(InputMap inputMap, ActionMap actionMap) {
    inputMap.put(KeyStroke.getKeyStroke(KeyEvent.VK_ADD, InputEvent.CTRL_DOWN_MASK), "plus");
    inputMap.put(KeyStroke.getKeyStroke(KeyEvent.VK_EQUALS, KeyEvent.CTRL_DOWN_MASK), "plus");
    inputMap.put(KeyStroke.getKeyStroke(KeyEvent.VK_SUBTRACT, InputEvent.CTRL_DOWN_MASK), "minus");
    inputMap.put(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, InputEvent.CTRL_DOWN_MASK), "minus");
